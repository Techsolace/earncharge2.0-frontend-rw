      ...
      <div className="max-w-6xl mx-auto px-6 py-16 mt-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-light mb-8 text-white">Get in Touch</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="border border-white/20 p-6 hover:bg-white/5 transition-all duration-300">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-light text-white mb-2">Phone Support</h3>
                      <a
                      ...
                      <p className="text-white/50 text-sm mt-1 font-light">Available 24/7</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border border-white/20 p-6 hover:bg-white/5 transition-all duration-300">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-light text-white mb-2">Email Support</h3>
                      <a
                      ...
                      <p className="text-white/50 text-sm mt-1 font-light">We&quot;ll respond within 24 hours</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border border-white/20 p-6 hover:bg-white/5 transition-all duration-300">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-light text-white mb-2">Office Address</h3>
                ...
                <div className="border border-white/20 p-6 hover:bg-white/5 transition-all duration-300">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-light text-white mb-2">Business Hours</h3>
                      <p className="text-white/70 font-light">
                        24/7 Customer Support
                        <br />
                        <span className="text-white/50 text-sm">Always here to help you</span>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="firstName" className="block text-white/70 text-sm font-light mb-2">
                    First Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="lastName" className="block text-white/70 text-sm font-light mb-2">
                    Last Name
                  </label>
                  <input
                    type="text"
              ...
              <div>
                <label htmlFor="subject" className="block text-white/70 text-sm font-light mb-2">
                  Subject
                </label>
                <input
                  type="text"
        ...
        {/* Map Section */}
        <div className="mt-16">
          <h2 className="text-2xl font-light mb-8 text-white text-center">Find Us on Map</h2>
          ...
          <p className="text-white/50 text-sm text-center mt-4 font-light">
            Plot No: 326, behind LAD Collage, Shankar Nagar, Nagpur, Maharashtra 440010
          </p>
        </div>
      </div>
    <Footer />
